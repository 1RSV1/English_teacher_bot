...
ffprobe_path = which("ffprobe") or "./ffprobe.exe"
...
async def handle_all_audios(message: Message):
    ...
    spelling = [{"role": "system", "content": f"Correct spelling.  If a sentence has a mistake, wrap the mistake in '~' and add a correction wrapped in '*' right after the mistake."}, {'role': 'user', 'content': transcription}]       
